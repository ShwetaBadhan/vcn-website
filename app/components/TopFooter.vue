          ...
          <div class="col-md-5">
            <div class="vcn-footer-brand">
              ...
              <p class="vcn-footer-tagline">
                Pioneering
                <span class="vcn-footer-tagline-icon"
                  ><svg
                    width="31"
                    height="33"
                    viewBox="0 0 31 33"
                  ...
                  >
                    <path
                      d="M12.0785 22.1018L6.86646 16.8897L8.95126 14.8049L14.1633 20.017L12.0785 22.1018Z"
                      stroke="#FFFFFF"
                      stroke-width="1.7"
                    ...
                    ></path>
                    <path
                      d="M1.65428 16.8905L12.0783 27.2098"
                      stroke="#FFFFFF"
                      stroke-width="1.7"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    ...
                    ></path>
                    <path
                      d="M23.0241 1.7749L19.8969 4.90212L24.0665 9.07173L27.1937 5.94452L23.0241 1.7749Z"
                      stroke="#FFFFFF"
                      stroke-width="1.7"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                ...
                <span class="vcn-footer-tagline-icon"
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="#FCFCF7"
                      mask="url(#path-1-inside-1_8140_3689)"
                    ></path></svg
                ></span>
                ...
                <span class="vcn-footer-tagline-icon"
                  ...
                  >
                    ...
                    <path
                      fill="#FFFFFF"
                      d="M30.7207 8.00127v1.5H0v-1.5h30.7207Z"
                    ></path>
                    <path
                      fill="#FFFFFF"
                    ...
                    <path
                      fill="#FFFFFF"
                      d="M14.4192.000723h1.5V17.5037h-1.5V.000723Z"
                    ></path></svg
                ></span>
                <br />
                since 2015.
            ...
            <div class="vcn-footer-newsletter">
              ...
              <form class="vcn-footer-newsletter-form">
                <div class="vcn-footer-input-wrapper">
                  <input
                    type="text"
                    class="vcn-footer-newsletter-input"
                    placeholder="Enter your email"
                  />
                </div>
                <button type="submit" class="vcn-footer-newsletter-btn">
                  →
                </button>
              </form>
            ...
            <div class="vcn-footer-links-section">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                  <h4 class="vcn-footer-column-title">Products</h4>
                  <ul class="vcn-footer-links-list">
                    <li>
                      <a href="/all-products" class="vcn-footer-link"
                        >Shop All</a
                      >
                    </li>
                  </ul>
                ...
                <!-- About Column -->
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                  <h4 class="vcn-footer-column-title">About</h4>
                  <ul class="vcn-footer-links-list">
                    <li>
                      <a href="/about-us" class="vcn-footer-link"
                        >Who We Are</a
                      >
                    </li>
                    <li>
                      <a href="/approach" class="vcn-footer-link"
                        >Science</a
                      >
                    </li>
                    <li>
                      <a href="/sustainability" class="vcn-footer-link"
                        >Sustainability</a
                      >
                    </li>
                    <li>
                      <a href="/vcn-labs" class="vcn-footer-link"
                        >VCNLabs</a
                      >
                    </li>
                  </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                  ...
                  <ul class="vcn-footer-links-list">
                    <li>
                      <a href="/vcn-university" class="vcn-footer-link"
                        >Partner</a
                      >
                    </li>
                    <li>
                      <a href="/practitioners" class="vcn-footer-link"
                        >Practitioners</a
                      >
                    </li>
                ...
                <!-- Help Column -->
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                  <h4 class="vcn-footer-column-title">Help</h4>
                  <ul class="vcn-footer-links-list">
                    <li>
                      <a href="javascript:void(0)" class="vcn-footer-link"
                        >Help</a
                      >
                    </li>
                    <li>
                      <a href="/contact-us" class="vcn-footer-link"
                        >Contact</a
                      >
                    </li>
                    <li>
                      <a href="/login" class="vcn-footer-link"
                        >My Account</a
                      >
                    </li>
                    <li>
                      <a href="/entire-world" class="vcn-footer-link"
                        >International</a
                      >
                    </li>
                  </ul>
                ...
                <!-- Social Column -->
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                  <h4 class="vcn-footer-column-title">Social</h4>
                  <ul class="vcn-footer-links-list">
                    <li><a href="https://www.instagram.com/vcnorganic/" target="_blank" class="vcn-footer-link">Instagram</a></li>
                    <li><a href="https://www.facebook.com/VCNorganic" target="_blank" class="vcn-footer-link">Facebook</a></li>
                    <li><a href="https://in.pinterest.com/vcn_organic/" target="_blank" class="vcn-footer-link">Pinterest</a></li>
                ...
                <!-- Legal Column -->
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                  <h4 class="vcn-footer-column-title">Legal</h4>
                  <ul class="vcn-footer-links-list">
                    <li>
                      <a href="/terms-conditions" class="vcn-footer-link"
                        >Terms + Conditions</a
                      >
                    </li>
                    <li>
                      <a href="/privacy-policy" class="vcn-footer-link"
                        >Privacy Policy</a
                      >
                    </li>
                    <li>
                      <a href="/accessibility" class="vcn-footer-link"
                        >Accessibility</a
                      >
                    </li>
                    <li>
