        ...
        <div class="col-md-5">
          ...
          <div class="vcn-footer-newsletter">
            <h3 class="vcn-footer-newsletter-title">
              Stay Connected with VCN — Wellness Updates in Your Inbox
            </h3>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                ...
                <ul class="vcn-footer-links-list">
                  <li>
                    <a href="/all-products" class="vcn-footer-link">Shop All</a>
                  </li>
                </ul>
              </div>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                ...
                <ul class="vcn-footer-links-list">
                  ...
                  <li>
                    <a href="/book-consultancy" class="vcn-footer-link">Book Consultancy</a>
                  </li>
                </ul>
              </div>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                ...
                <ul class="vcn-footer-links-list">
                  <li>
                    <a href="javascript:void(0)" class="vcn-footer-link">Help</a>
                  </li>
                  <li>
                    <a href="/contact-us" class="vcn-footer-link">Contact</a>
                  </li>
                  <li>
