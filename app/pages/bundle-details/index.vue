     ...
     <section class="terms-conditions">
      ...
      <div class="container">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-lg-6">
            <img
              src="https://vcarenetwork.in/login/public/uploads/section/26/img_687de7647f0803.56861309.jpg"
              class="w-100"
              alt=""
            />
            <p class="mt-2">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                  <div class="vcn-acidity-benefit-card">
                    ...
                    <div class="vcn-acidity-benefit-icon">
                      <img
                        src="https://www.miduty.in/cdn/shop/files/Acidity_Digetion.svg?v=1689745460"
                        alt=""
                      />
                    </div>
                    <p class="vcn-acidity-benefit-text">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                  <div class="vcn-acidity-benefit-card">
                    ...
                    <div class="vcn-acidity-benefit-icon">
                      <img
                        src="https://www.miduty.in/cdn/shop/files/Frame_1_2.svg?v=1689763787"
                        alt=""
                      />
                    </div>
                    <p class="vcn-acidity-benefit-text">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                  <div class="vcn-acidity-benefit-card">
                    ...
                    <div class="vcn-acidity-benefit-icon">
                      <img
                        src="http://miduty.in/cdn/shop/files/Acidity_Good_bacteria.svg?v=1689745749"
                        alt=""
                      />
                    </div>
                    <p class="vcn-acidity-benefit-text">
      ...
      <div class="expand-section">
        ...
        <div class="expandable-section" id="reasonSection">
          <div
            ...
            onclick="toggleSection('reasonSection')"
          >
            <div class="trigger-left-area">
              <div class="circle-badge">
                <img
                  src="https://www.miduty.in/cdn/shop/files/reason-faq-img.png?v=1681489769"
                  alt=""
                />
              </div>
        ...
        <div class="expandable-section" id="avoidSection">
          <div
            class="accordion-trigger"
            onclick="toggleSection('avoidSection')"
          >
            <div class="trigger-left-area">
              <div class="circle-badge">
                <img
                  src="https://www.miduty.in/cdn/shop/files/avoid.png?v=1690353201"
                  alt=""
                />
              </div>
        ...
        <div class="expandable-section" id="riskSection">
          <div class="accordion-trigger" onclick="toggleSection('riskSection')">
            <div class="trigger-left-area">
              <div class="circle-badge">
                <img
                  src="https://www.miduty.in/cdn/shop/files/Group_2609999.png?v=1681698542"
                  alt=""
                />
              </div>
        ...
        <div class="expandable-section" id="tipsSection">
          <div class="accordion-trigger" onclick="toggleSection('tipsSection')">
            <div class="trigger-left-area">
              <div class="circle-badge">
                <img
                  src="https://www.miduty.in/cdn/shop/files/golden-tips.png?v=1690353144"
                  alt=""
                />
              </div>
        ...
        <div class="col-lg-6 col-md-12">
          <div class="care-card">
            <div class="icon-circle">
              <img
                src="https://www.miduty.in/cdn/shop/files/diet-img.png?v=1681574626"
                alt=""
              />
            </div>
          ...
          <div class="care-card">
            ...
            <p class="card-content">
              ...
              <span class="highlight-text"
                >Betaine HCL + Pepsin, Vitamin B12, Leaky Gut</span
              >
            </p>
          </div>
        </div>
