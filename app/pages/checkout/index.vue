          ...
          <div class="checkout-step-card" id="accountStepCard">
            <div class="checkout-step-header">
              <div class="step-indicator">
                <span class="step-count-badge">1 of 3</span>
              </div>
              <h2 class="step-title-text">Create Your Account</h2>
            </div>

            <div class="checkout-step-body" id="accountStepContent">
              <button
                class="secondary-action-btn w-100"
                onclick="proceedWithGoogle()"
              >
                <span class="google-icon-text me-2">G</span> Continue with
                Google
              </button>
              ...
              <a
                class="primary-action-btn w-100 mb-3"
                onclick="displayEmailForm()"
              >
                Sign Up with Email
              </a>
              ...
              <div id="emailSignupForm" class="hide-element">
                ...
                <a
                  class=" primary-action-btn w-100"
              ...
              <div class="info-box">
                <div class="info-box-left">
                  ...
                  <p class="info-box-description">
                    Your body is home to 38 trillion bacteria. 95% of these (36
                    trillion) live in your gut.
                  </p>
                </div>
                <div class="info-box-right">
                  <input type="checkbox" id="newsletterCheckbox" checked />
                  <div class="info-box-right-text">
                    Guide me along the way with tips, information, and nerdy
                    reads. Unsubscribe anytime.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              class="checkout-step-body hide-element"
              id="accountStepCompleted"
            >
          ...
          <div class="checkout-step-card step-disabled" id="paymentStepCard">
            ...
            >
              <div class="row g-3">
                ...
                <div class="col-12">
                  <a 
                    class=" primary-action-btn w-100 final-order-btn"
                    onclick="submitPaymentInfo()"
                  >
                    Place Order - <span id="finalOrderTotal">$39.99</span>
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-5">
          <div class="card cart-summary-card">
            <div class="card-body p-4">
              ...
              <!-- Product Display -->
              <div class="d-flex mb-4 product-wrapper">
                <div class="product-image-container me-3">
                  <img src="https://res.cloudinary.com/dljz0lko8/image/upload/f_auto,q_auto/v1693433672/cart/DS01_2x.png" class="w-100" alt="">
                </div>
                <div class="flex-grow-1">
                  <h6 class="product-name-text">DM-02™ Daily Multivitamin</h6>
                  <small class="product-delivery-info">Delivered monthly</small>
                  <div class="d-flex align-items-center mt-2">
                  <div class="cart-quantity-control">
    <button class="cart-qty-button" onclick="decrementQuantity(this)">−</button>
    <div class="cart-qty-display" data-qty>1</div>
    <button class="cart-qty-button" onclick="incrementQuantity(this)">+</button>
</div>
                ...
                <div class="text-end">
                  <div class="price-display-text" id="productPriceDisplay">
                    $39.99
                  </div>
                </div>
              </div>
    ...
    <button class="cart-qty-button" onclick="incrementQuantity(this)">+</button>
              ...
              <div class="mb-4">
               ...
               <div class="cart-promo-section">
                        <div class="cart-promo-label">Promo Code
                            <br>We found you a better deal! Applied holiday30 (30% off) for higher savings.
                        </div>
                        <div class="cart-promo-input-group">
                            <input type="text" class="cart-promo-input" placeholder="Enter Promo Code">
                            <button class="cart-promo-apply-btn">Apply</button>
                        </div>
                    </div>
              </div>
              ...
              <div class="summary-row">
                ...
                <span class="summary-value" id="orderSubtotal">$39.99</span>
              </div>
              <div class="summary-row">
                <span class="summary-label">Shipping</span>
                <span class="summary-free-text">Free</span>
              </div>
              <div class="summary-row">
