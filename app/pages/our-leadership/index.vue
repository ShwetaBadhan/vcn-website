                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <div class="hero-image">
                                            <img
                                                src="/img/leadership/ourleadership.jpeg"
                                                alt="Leadership"
                                            />
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="hero-contents">
                                            ...
                                            <p class="hero-texts">
                                                ...
                                                us to live our best lives every
                                                day. With their diverse
                                                expertise and forward-thinking
                                                approach, they empower Herbalife
                                                Independent Distributors and
                                                employees to achieve our vision
