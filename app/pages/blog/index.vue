  ...
  <section class="product-detail-section mt-3">
    <section class="vcn-blogs-page py-5">
      <div class="container">
        ...
        <!-- Section Title -->
        <h2 class="vcn-section-title text-center fw-semibold mb-5">All blog posts</h2>
          ...
          >
            <div class="vcn-blog-card card h-100 border-0 shadow-sm">
              <div class="vcn-blog-image-wrapper position-relative overflow-hidden">
                ...
                <span class="vcn-blog-category position-absolute top-0 end-0 m-3 px-3 py-1 bg-white rounded small fw-bold text-success">
                  {{ blog.category }}
                </span>
              </div>
              <div class="vcn-blog-content card-body d-flex justify-content-between align-items-start gap-3">
                ...
                <a href="/blog-details" class="vcn-read-more-btn btn btn-success rounded-circle p-2 flex-shrink-0">
                  <i class="bi bi-arrow-right"></i>
                </a>
              </div>
               <div class="blog-metas">
              <span class="authors">
                <i class="bi bi-person"></i> Content VCN
              </span>
              <span class="dates">
