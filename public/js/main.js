...
function showPromoModal() {
  document.getElementById('promoModalOverlay').classList.add('promo-active-modal');
}

function closePromoModal() {
  document.getElementById('promoModalOverlay').classList.remove('promo-active-modal');
}
