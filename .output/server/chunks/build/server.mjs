import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, readonly, resolveComponent, hasInjectionContext, inject, ref, mergeProps, toRef, isRef, computed, reactive, defineAsyncComponent, useSSRContext, unref, shallowReactive, Suspense, Fragment, createApp, onServerPrefetch, mergeModels, useModel, withCtx, renderSlot, createVNode, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, watch, resolveDynamicComponent, renderList, useId, onErrorCaptured, effectScope, isReadonly, isShallow, isReactive, toRaw, toValue, useSlots, useTemplateRef, withModifiers, getCurrentScope, nextTick, markRaw } from 'vue';
import { k as serialize, l as parseQuery, p as publicAssetsURL, m as hasProtocol, n as joinURL, w as withQuery, o as withTrailingSlash, q as withoutTrailingSlash, r as isScriptProtocol, v as sanitizeStatusCode, x as getContext, $ as $fetch$1, y as baseURL, z as defuFn, A as klona, B as defu, C as createHooks, D as executeAsync, i as createError$1, E as isEqual, F as toRouteMatcher, G as createRouter$1 } from '../_/nitro.mjs';
...
import { ssrRenderAttrs, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderComponent, ssrRenderClass, ssrRenderList, ssrInterpolate, ssrRenderDynamicModel, ssrRenderTeleport, ssrLooseContain, ssrRenderSlot, ssrRenderVNode, ssrRenderSuspense, ssrRenderStyle } from 'vue/server-renderer';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Da4pTWDu.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-BS_A-Y_n.mjs')
  },
  {
    name: "cart",
    path: "/cart",
    component: () => import('./index-CB4wLUQP.mjs')
  },
  {
    name: "faqs",
    path: "/faqs",
    component: () => import('./index-BttOtN1z.mjs')
  },
  {
    name: "news",
    path: "/news",
    component: () => import('./index-Cf_W-VFu.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./index-63Wj05X0.mjs')
  },
  {
    name: "careers",
    path: "/careers",
    component: () => import('./index-CpPUH9c5.mjs')
  },
  {
    name: "about-us",
    path: "/about-us",
    component: () => import('./index-Dj5nmYky.mjs')
  },
  {
    name: "approach",
    path: "/approach",
    component: () => import('./index-BgMfG1gX.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./index-Dj3cHE6B.mjs')
  },
  {
    name: "vcn-labs",
    path: "/vcn-labs",
    component: () => import('./index-B_4FXnxt.mjs')
  },
  {
    name: "contact-us",
    path: "/contact-us",
    component: () => import('./index-DBEFnlkX.mjs')
  },
  {
    name: "disclaimer",
    path: "/disclaimer",
    component: () => import('./index-Dqwg45Wm.mjs')
  },
  {
    name: "microbiome",
    path: "/microbiome",
    component: () => import('./index-BaF7_VJr.mjs')
  },
  {
    name: "RegistrationPage",
    path: "/RegistrationPage",
    component: () => import('./RegistrationPage-Dg8wiJmz.mjs')
  },
  {
    name: "our-journey",
    path: "/our-journey",
    component: () => import('./index-ChA2q1-c.mjs')
  },
  {
    name: "all-products",
    path: "/all-products",
    component: () => import('./index-B7esmK1O.mjs')
  },
  {
    name: "blog-details",
    path: "/blog-details",
    component: () => import('./index-cU1XRZsy.mjs')
  },
  {
    name: "entire-world",
    path: "/entire-world",
    component: () => import('./index-jr0zSBBT.mjs')
  },
  {
    name: "accessibility",
    path: "/accessibility",
    component: () => import('./index-ClDLWZXX.mjs')
  },
  {
    name: "how-vcn-works",
    path: "/how-vcn-works",
    component: () => import('./index-U86niA2L.mjs')
  },
  {
    name: "practitioners",
    path: "/practitioners",
    component: () => import('./index-awGFdI-k.mjs')
  },
  {
    name: "bundle-details",
    path: "/bundle-details",
    component: () => import('./index-DQkViN0f.mjs')
  },
  {
    name: "our-leadership",
    path: "/our-leadership",
    component: () => import('./index-CiNQcXxW.mjs')
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import('./index-BQ6iMfkm.mjs')
  },
  {
    name: "share-and-earn",
    path: "/share-and-earn",
    component: () => import('./index-C86VBj1s.mjs')
  },
  {
    name: "sustainability",
    path: "/sustainability",
    component: () => import('./index-D1IfwET0.mjs')
  },
  {
    name: "vcn-university",
    path: "/vcn-university",
    component: () => import('./index-DMDbaHq6.mjs')
  },
  {
    name: "product-details",
    path: "/product-details",
    component: () => import('./index-DxGNZ5nH.mjs')
  },
  {
    name: "shipping-policy",
    path: "/shipping-policy",
    component: () => import('./index-BOek1J4s.mjs')
  },
  {
    name: "book-consultancy",
    path: "/book-consultancy",
    component: () => import('./index-D-j4Ouzt.mjs')
  },
  {
    name: "product-details-slug",
    path: "/product-details/:slug()",
    component: () => import('./_slug_-DevkaA6Z.mjs')
  },
  {
    name: "terms-conditions",
    path: "/terms-conditions",
    component: () => import('./index-nG8Pedl1.mjs')
  },
  {
    name: "all-disease-bundles",
    path: "/all-disease-bundles",
    component: () => import('./index-BYmFGp1b.mjs')
  },
  {
    name: "grievance-redressal",
    path: "/grievance-redressal",
    component: () => import('./index-BgEEUTGl.mjs')
  },
  {
    name: "cancellation-and-refund-process",
    path: "/cancellation-and-refund-process",
    component: () => import('./index-Cbbzt-vJ.mjs')
  }
];
...
const _sfc_main$h = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(props.chip ? _sfc_main$i : unref(Primitive)), mergeProps({
        as: as.value.root
              ...
              _push2(ssrRenderComponent(unref(Slot), _ctx.$attrs, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      renderSlot(_ctx.$slots, "default", {}, () => [
                        __props.icon ? (openBlock(), createBlock(_sfc_main$j, {
                          key: 0,
                          name: __props.icon,
                          "data-slot": "icon",
                          class: ui.value.icon({ class: props.ui?.icon })
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$f, mergeProps({
        ...
        default: withCtx(({ active, ...slotProps }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$g, mergeProps(slotProps, {
              "data-slot": "base",
              class: ui.value.base({
                ...
                if (_push3) {
                  ...
                  return [
                    renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                      unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(_sfc_main$j, {
                        key: 0,
                        name: unref(leadingIconName),
                        "data-slot": "leadingIcon",
                        class: ui.value.leadingIcon({ class: props.ui?.leadingIcon, active })
                    ...
                    renderSlot(_ctx.$slots, "trailing", { ui: ui.value }, () => [
                      unref(isTrailing) && unref(trailingIconName) ? (openBlock(), createBlock(_sfc_main$j, {
                        key: 0,
                        name: unref(trailingIconName),
                        "data-slot": "trailingIcon",
                        class: ui.value.trailingIcon({ class: props.ui?.trailingIcon, active })
      ...
      _push(ssrRenderComponent(unref(ToastRoot), mergeProps({
        ...
        default: withCtx(({ remaining, duration, open }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                __props.avatar ? (openBlock(), createBlock(_sfc_main$h, mergeProps({
                  key: 0,
                  size: props.ui?.avatarSize || ui.value.avatarSize()
                }, __props.avatar, {
                  "data-slot": "avatar",
                  class: ui.value.avatar({ class: props.ui?.avatar })
                }), null, 16, ["size", "class"])) : __props.icon ? (openBlock(), createBlock(_sfc_main$j, {
                  key: 1,
                  name: __props.icon,
                  "data-slot": "icon",
                  class: ui.value.icon({ class: props.ui?.icon })
              ...
              __props.progress && open && remaining > 0 && duration ? (openBlock(), createBlock(_sfc_main$d, mergeProps({
                key: 1,
                "model-value": remaining / duration * 100,
                color: __props.color
              }, typeof __props.progress === "object" ? __props.progress : {}, {
...
const UToaster = Object.assign(_sfc_main$b, { __name: "UToaster" });
...
const __nuxt_component_0$1 = Object.assign(_sfc_main$9, { __name: "UApp" });
const layouts = {
  default: defineAsyncComponent(() => import('./default-DvSX78oi.mjs').then((m) => m.default || m))
};
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$1]]);
const _imports_0$2 = publicAssetsURL("/img/404-image.png");
const _sfc_main$7 = {
  __name: "TopHeader",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["top-header", { "hide": isHydrated.value && isHidden.value }],
        id: "topHeader"
      }, _attrs))}><p> Because Your Health Deserves Better <span class="arrow">→</span></p></div>`);
    };
  }
};
...
const __nuxt_component_0 = Object.assign(_sfc_main$7, { __name: "TopHeader" });
const _imports_0$1 = publicAssetsURL("/img/logo/logo.png");
const _imports_1 = publicAssetsURL("/img/image/vcnlabs.png");
const _imports_2 = publicAssetsURL("/img/icons/login_google.svg");
const _imports_3 = publicAssetsURL("/img/icons/login_facebook.svg");
const _sfc_main$6 = {
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/RegistrationForm.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const RegistrationForm = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$6, [["__scopeId", "data-v-a80b5218"]]), { __name: "RegistrationForm" });
const useCartStore = defineStore("cart", {
  ...
  actions: {
    ...
    removeFromCart(productId) {
      const index2 = this.items.findIndex((item) => item.id === productId);
      if (index2 > -1) {
...
const useApi = () => {
  const config = /* @__PURE__ */ useRuntimeConfig();
  const baseURL2 = config.public.apiBaseUrl;
  const get2 = async (endpoint) => {
    try {
      const data = await $fetch(`${baseURL2}${endpoint}`, {
        method: "GET"
      });
  ...
  const getFromUrl = async (url) => {
    const fullUrl = url.startsWith("http") ? url : `${baseURL2}${url}`;
    try {
  ...
  const getFromEndpoint = async (endpointKey) => {
    const endpoint = API_ENDPOINTS[endpointKey];
    return get2(endpoint);
  };
  const postToEndpoint = async (endpointKey, body) => {
    const endpoint = API_ENDPOINTS[endpointKey];
    return post(endpoint, body);
  };
  const prefetchEndpoint = (endpointKey) => {
  };
  return {
    get: get2,
    getFromUrl,
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ClientOnly = __nuxt_component_0$4;
      _push(`<!--[--><header data-v-e4d8b50d><nav class="${ssrRenderClass([{ "scrolled": isHydrated.value && isScrolled.value }, "navbar"])}" id="navbar" data-v-e4d8b50d><div class="container-fluid" data-v-e4d8b50d><a class="navbar-brand d-lg-none" href="#" data-v-e4d8b50d><img${ssrRenderAttr("src", _imports_0$1)} alt="Logo" class="nav-img" data-v-e4d8b50d></a><div class="d-lg-none d-flex align-items-center" data-v-e4d8b50d><a href="/cart" class="mobile-cart" data-v-e4d8b50d> Cart `);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`</a><button class="custom-navbar-toggler" type="button" onclick="toggleMenu()" aria-label="Toggle menu" data-v-e4d8b50d><span class="hamburger-line" data-v-e4d8b50d></span><span class="hamburger-line" data-v-e4d8b50d></span><span class="hamburger-line" data-v-e4d8b50d></span></button></div><div class="nav-left-wrapper d-none d-lg-flex" data-v-e4d8b50d><a class="navbar-brand" href="/" data-v-e4d8b50d><img${ssrRenderAttr("src", _imports_0$1)} alt="Logo" class="nav-img" data-v-e4d8b50d></a><ul class="desktop-nav" data-v-e4d8b50d><li class="nav-item dropdown" data-v-e4d8b50d><a class="nav-link" href="#" data-v-e4d8b50d>Shop</a><ul class="dropdown-menu" data-v-e4d8b50d><!--[-->`);
      ssrRenderList(shopProducts.value, (product) => {
        _push(`<li data-v-e4d8b50d><a class="dropdown-item"${ssrRenderAttr("href", `/product-details/${product.slug}`)} data-v-e4d8b50d><img${ssrRenderAttr("src", getProductImage(product))}${ssrRenderAttr("alt", product.name)} data-v-e4d8b50d> ${ssrInterpolate(product.name)}</a></li>`);
      });
      _push(`<!--]--><li class="dropdown-footer" data-v-e4d8b50d><a href="/all-products" data-v-e4d8b50d>Shop All Products →</a></li></ul></li><li class="nav-item dropdown" data-v-e4d8b50d><a class="nav-link" href="#" data-v-e4d8b50d>Science</a><ul class="dropdown-menu" data-v-e4d8b50d><li data-v-e4d8b50d><a class="dropdown-item" href="/approach" data-v-e4d8b50d><img src="https://res.cloudinary.com/dljz0lko8/image/upload/f_auto,q_auto/v1755487791/library/nav/science/approach.png" alt="Approach" data-v-e4d8b50d><strong data-v-e4d8b50d>Approach<br data-v-e4d8b50d>Micro</strong></a></li><li data-v-e4d8b50d><a class="dropdown-item" href="/vcn-labs" data-v-e4d8b50d><img${ssrRenderAttr("src", _imports_1)} alt="VCN Labs" data-v-e4d8b50d><strong data-v-e4d8b50d>VCN Labs</strong></a></li><li data-v-e4d8b50d><a class="dropdown-item" href="/approach#scientists" data-v-e4d8b50d><img src="https://res.cloudinary.com/dljz0lko8/image/upload/f_auto,q_auto/v1755487801/library/nav/science/scientists.png" alt="VCN Labs" data-v-e4d8b50d><strong data-v-e4d8b50d>Scientists</strong></a></li><li data-v-e4d8b50d><a class="dropdown-item" href="/sustainability" data-v-e4d8b50d><img src="https://res.cloudinary.com/dljz0lko8/image/upload/f_auto,q_auto/v1755487761/library/nav/science/sustainability.png" alt="VCN Labs" data-v-e4d8b50d><strong data-v-e4d8b50d>Sustainability</strong></a></li><li data-v-e4d8b50d><a href="" class="dropdown-item" data-v-e4d8b50d><strong data-v-e4d8b50d>References</strong></a></li><li data-v-e4d8b50d><a href="javascript:void(0)" class="dropdown-item" data-v-e4d8b50d><strong data-v-e4d8b50d>VCN-01 Daily Synbiotic</strong></a></li><li data-v-e4d8b50d><a href="javascript:void(0)" class="dropdown-item" data-v-e4d8b50d><strong data-v-e4d8b50d>DM-02™ Daily Multivitamin</strong></a></li><li data-v-e4d8b50d><a href="javascript:void(0)" class="dropdown-item" data-v-e4d8b50d><strong data-v-e4d8b50d>VCN-02 Energy + Focus</strong></a></li><li data-v-e4d8b50d><a href="javascript:void(0)" class="dropdown-item" data-v-e4d8b50d><strong data-v-e4d8b50d>PM-02™ Sleep + Restore</strong></a></li><li data-v-e4d8b50d><a href="javascript:void(0)" class="dropdown-item" data-v-e4d8b50d><strong data-v-e4d8b50d>PDS-08® Pediatric Synbiotic</strong></a></li><li data-v-e4d8b50d><a href="javascript:void(0)" class="dropdown-item" data-v-e4d8b50d><strong data-v-e4d8b50d>VS-01™ Vaginal Synbiotic</strong></a></li></ul></li><li class="nav-item dropdown" data-v-e4d8b50d><a class="nav-link" href="#" data-v-e4d8b50d>Learn</a><ul class="dropdown-menu" data-v-e4d8b50d><li data-v-e4d8b50d><a class="dropdown-item" href="/microbiome" data-v-e4d8b50d><img src="https://res.cloudinary.com/dljz0lko8/image/upload/f_auto,q_auto/v1755487912/library/nav/learn/microbiome.png" alt="Research" data-v-e4d8b50d> Microbiome </a></li><li data-v-e4d8b50d><a class="dropdown-item" href="#" data-v-e4d8b50d><img src="https://res.cloudinary.com/dljz0lko8/image/upload/f_auto,q_auto/v1755487978/library/nav/learn/probiotics.png" alt="Research" data-v-e4d8b50d> Probiotics </a></li></ul></li></ul></div><div class="nav-right-wrapper d-flex align-items-center" data-v-e4d8b50d><a href="#" class="login-link" data-v-e4d8b50d>Login</a><a href="/cart" class="navbar-btn" data-v-e4d8b50d> Cart `);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`</a>`);
      if (isOpen.value) {
        _push(`<div class="overlay" data-v-e4d8b50d></div>`);
      } else {
        _push(`<!---->`);
      }
      if (isOpen.value) {
        _push(`<div class="slide-form-container" data-v-e4d8b50d><button class="close-btn" data-v-e4d8b50d>×</button><div class="form-content" data-v-e4d8b50d><h2 data-v-e4d8b50d>Sign In</h2><form data-v-e4d8b50d><div class="form-group" data-v-e4d8b50d><label for="mobile" data-v-e4d8b50d>Mobile Number</label><input type="tel" id="mobile"${ssrRenderAttr("value", formData.mobile)} placeholder="+91" class="form-input" data-v-e4d8b50d></div><div class="form-group" data-v-e4d8b50d><label for="password" data-v-e4d8b50d>Password</label><div class="password-wrapper" data-v-e4d8b50d><input${ssrRenderAttr("type", showPassword.value ? "text" : "password")} id="password"${ssrRenderDynamicModel(showPassword.value ? "text" : "password", formData.password, null)} placeholder="Password" class="form-input" data-v-e4d8b50d><button type="button" class="toggle-password" data-v-e4d8b50d>${ssrInterpolate(showPassword.value ? "🙈" : "👁️")}</button></div></div><a href="#" class="forgot-password" data-v-e4d8b50d>Forgot Password</a><button type="submit" class="signin-btn" data-v-e4d8b50d>SIGN IN</button><div class="social-login" data-v-e4d8b50d><p data-v-e4d8b50d>Sign in with</p><div class="social-icons" data-v-e4d8b50d><button type="button" class="social-btn google" data-v-e4d8b50d><img${ssrRenderAttr("src", _imports_2)} alt="Google" data-v-e4d8b50d></button><button type="button" class="social-btn facebook" data-v-e4d8b50d><img${ssrRenderAttr("src", _imports_3)} alt="Facebook" data-v-e4d8b50d></button></div></div><div class="register-section" data-v-e4d8b50d><h3 data-v-e4d8b50d>Register <span class="info-icon" data-v-e4d8b50d>ⓘ</span></h3><button type="button" class="register-btn" data-v-e4d8b50d> PREFERRED CUSTOMER </button><button type="button" class="register-btn" data-v-e4d8b50d> VCN BUSINESS OWNER </button></div><div class="footer-links" data-v-e4d8b50d><a href="#" data-v-e4d8b50d>Terms &amp; Conditions</a><a href="#" data-v-e4d8b50d>Privacy</a></div></form></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="navbar-collapse" id="navbarContent" data-v-e4d8b50d><ul class="navbar-nav" data-v-e4d8b50d><li class="nav-item" data-v-e4d8b50d><a class="nav-link" href="#" onclick="toggleAccordion(event, &#39;shopAccordion&#39;)" data-v-e4d8b50d>Shop</a></li><li class="nav-item" data-v-e4d8b50d><a class="nav-link" href="#" onclick="toggleAccordion(event, &#39;scienceAccordion&#39;)" data-v-e4d8b50d>Science</a></li><li class="nav-item" data-v-e4d8b50d><a class="nav-link" href="#" onclick="toggleAccordion(event, &#39;learnAccordion&#39;)" data-v-e4d8b50d>Learn</a></li><li class="nav-item" data-v-e4d8b50d><a class="nav-link" href="login" data-v-e4d8b50d>Login</a></li></ul><div class="dropdown-content" id="shopAccordion" show data-v-e4d8b50d><div class="dropdown-menu-mobile" data-v-e4d8b50d><!--[-->`);
      ssrRenderList(shopProducts.value, (product) => {
        _push(`<a class="dropdown-item"${ssrRenderAttr("href", `/product-details/${product.slug}`)} data-v-e4d8b50d><img${ssrRenderAttr("src", getProductImage(product))}${ssrRenderAttr("alt", product.name)} data-v-e4d8b50d> ${ssrInterpolate(product.name)}</a>`);
      });
      _push(`<!--]--><div class="dropdown-footer" data-v-e4d8b50d><a href="/all-products" data-v-e4d8b50d>Shop All Products →</a></div></div></div><div class="dropdown-content" id="scienceAccordion" data-v-e4d8b50d><div class="dropdown-menu-mobile" data-v-e4d8b50d><a class="dropdown-item" href="/approach" data-v-e4d8b50d><img src="https://res.cloudinary.com/dljz0lko8/image/upload/f_auto,q_auto/v1755487791/library/nav/science/approach.png" alt="Approach" data-v-e4d8b50d><strong data-v-e4d8b50d>Approach<br data-v-e4d8b50d>Micro</strong></a><a class="dropdown-item" href="/vcn-labs" data-v-e4d8b50d><img${ssrRenderAttr("src", _imports_1)} alt="VCN Labs" data-v-e4d8b50d><strong data-v-e4d8b50d>VCN Labs</strong></a><a class="dropdown-item" href="/approach#scientists" data-v-e4d8b50d><img src="https://res.cloudinary.com/dljz0lko8/image/upload/f_auto,q_auto/v1755487801/library/nav/science/scientists.png" alt="VCN Labs" data-v-e4d8b50d><strong data-v-e4d8b50d>Scientists</strong></a><a class="dropdown-item" href="sustainability" data-v-e4d8b50d><img src="https://res.cloudinary.com/dljz0lko8/image/upload/f_auto,q_auto/v1755487761/library/nav/science/sustainability.png" alt="VCN Labs" data-v-e4d8b50d><strong data-v-e4d8b50d>Sustainability</strong></a></div></div><div class="dropdown-content" id="learnAccordion" data-v-e4d8b50d><div class="dropdown-menu-mobile" data-v-e4d8b50d><a class="dropdown-item" href="/microbiome" data-v-e4d8b50d><img src="https://res.cloudinary.com/dljz0lko8/image/upload/f_auto,q_auto/v1755487912/library/nav/learn/microbiome.png" alt="Research" data-v-e4d8b50d> Microbiome </a><a class="dropdown-item" href="#" data-v-e4d8b50d><img src="https://res.cloudinary.com/dljz0lko8/image/upload/f_auto,q_auto/v1755487978/library/nav/learn/probiotics.png" alt="Research" data-v-e4d8b50d> Probiotics </a></div></div></div></div></nav></header>`);
      ssrRenderTeleport(_push, (_push2) => {
        if (showRegistration.value) {
          _push2(`<div class="registration-overlay" data-v-e4d8b50d></div>`);
        } else {
          _push2(`<!---->`);
        }
        if (showRegistration.value) {
          _push2(ssrRenderComponent(RegistrationForm, {
            userType: selectedUserType.value,
            onClose: ($event) => showRegistration.value = false,
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$5, [["__scopeId", "data-v-e4d8b50d"]]), { __name: "Navbar" });
const _sfc_main$4 = {
  __name: "ConsentPreferencesModal",
  __ssrInlineRender: true,
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (showConsentModal.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "vcn-consent-modal-overlay" }, _attrs))}><div class="vcn-consent-modal"><div class="vcn-consent-modal-header"><h3 class="vcn-consent-modal-title"><i class="bi bi-shield-lock me-2"></i> Your Privacy Choices as a Consumer </h3><button class="vcn-modal-close"><i class="bi bi-x-lg"></i></button></div><div class="vcn-consent-modal-body"><div class="vcn-consent-info mb-4"><p class="mb-3"> This website uses cookies and other similar technologies (referred to as &quot;cookies&quot; below), including some with tracking functionality, to enhance user experience and to analyze performance and traffic on our website. Certain cookies and similar technologies may also share information about your use of our website with social media, advertising and/or analytics partners. Further information is available in our <a href="#" class="vcn-link">Privacy Policy</a> and <a href="#" class="vcn-link">Cookie Policy</a>. </p><p class="mb-3"> This website honors Global Privacy Controls (GPCs), or opt-out preference signals. If your browser GPC is &quot;on,&quot; we interpret it as a request for that browser to opt-out of sharing for third-party targeted advertising and to opt-out of &quot;selling&quot; of personal information. To opt-out of sharing for third-party targeted advertising and to opt-out of &quot;selling&quot; of personal information, you can adjust the toggles below. </p><p class="mb-3"> Note: If you opt-out of certain cookies, you may continue to see online (non-targeted) advertising from us on other websites and online services. In addition, because certain opt-outs rely on cookies, if you delete cookies from your browser, you may need to opt-out again. </p><a href="#" class="vcn-link">More information</a></div><div class="vcn-consent-preferences"><h5 class="vcn-consent-section-title mb-3">Manage Consent Preferences</h5><div class="vcn-consent-item"><div class="vcn-consent-item-header"><div class="vcn-consent-item-title"><i class="${ssrRenderClass([{ "vcn-expanded": expandedItems.essential }, "bi bi-plus-lg vcn-expand-icon"])}"></i> Essential Cookies </div><span class="vcn-always-active">Always Active</span></div>`);
        if (expandedItems.essential) {
          _push(`<div class="vcn-consent-item-description"> These cookies are necessary for the website to function and cannot be switched off in our systems. </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="vcn-consent-item"><div class="vcn-consent-item-header"><div class="vcn-consent-item-title"><i class="${ssrRenderClass([{ "vcn-expanded": expandedItems.functional }, "bi bi-plus-lg vcn-expand-icon"])}"></i> Functional/Preference Cookies </div><div class="form-check form-switch vcn-toggle-switch"><input class="form-check-input" type="checkbox" role="switch" id="vcn-functional-toggle"${ssrIncludeBooleanAttr(Array.isArray(consentPreferences.functional) ? ssrLooseContain(consentPreferences.functional, null) : consentPreferences.functional) ? " checked" : ""}></div></div>`);
        if (expandedItems.functional) {
          _push(`<div class="vcn-consent-item-description"> These cookies enable the website to provide enhanced functionality and personalization. </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="vcn-consent-item"><div class="vcn-consent-item-header"><div class="vcn-consent-item-title"><i class="${ssrRenderClass([{ "vcn-expanded": expandedItems.analytics }, "bi bi-plus-lg vcn-expand-icon"])}"></i> Analytics/Performance Cookies </div><div class="form-check form-switch vcn-toggle-switch"><input class="form-check-input" type="checkbox" role="switch" id="vcn-analytics-toggle"${ssrIncludeBooleanAttr(Array.isArray(consentPreferences.analytics) ? ssrLooseContain(consentPreferences.analytics, null) : consentPreferences.analytics) ? " checked" : ""}></div></div>`);
        if (expandedItems.analytics) {
          _push(`<div class="vcn-consent-item-description"> These cookies allow us to count visits and traffic sources so we can measure and improve the performance of our site. </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="vcn-consent-item"><div class="vcn-consent-item-header"><div class="vcn-consent-item-title"><i class="${ssrRenderClass([{ "vcn-expanded": expandedItems.social }, "bi bi-plus-lg vcn-expand-icon"])}"></i> Social Media Cookies </div><div class="form-check form-switch vcn-toggle-switch"><input class="form-check-input" type="checkbox" role="switch" id="vcn-social-toggle"${ssrIncludeBooleanAttr(Array.isArray(consentPreferences.social) ? ssrLooseContain(consentPreferences.social, null) : consentPreferences.social) ? " checked" : ""}></div></div>`);
        if (expandedItems.social) {
          _push(`<div class="vcn-consent-item-description"> These cookies are set by social media services that we have added to the site to enable you to share our content with your friends and networks. </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="vcn-consent-item"><div class="vcn-consent-item-header"><div class="vcn-consent-item-title"><i class="${ssrRenderClass([{ "vcn-expanded": expandedItems.marketing }, "bi bi-plus-lg vcn-expand-icon"])}"></i> Marketing Cookies </div><div class="form-check form-switch vcn-toggle-switch"><input class="form-check-input" type="checkbox" role="switch" id="vcn-marketing-toggle"${ssrIncludeBooleanAttr(Array.isArray(consentPreferences.marketing) ? ssrLooseContain(consentPreferences.marketing, null) : consentPreferences.marketing) ? " checked" : ""}></div></div>`);
        if (expandedItems.marketing) {
          _push(`<div class="vcn-consent-item-description"> These cookies may be set through our site by our advertising partners to build a profile of your interests and show you relevant adverts on other sites. </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div><div class="vcn-consent-modal-footer"><button class="vcn-stories-card-btn"> Reject All </button><button class="view-more-btn"> Confirm My Choices </button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ConsentPreferencesModal.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const ConsentPreferencesModal = Object.assign(_sfc_main$4, { __name: "ConsentPreferencesModal" });
function useToast() {
  {
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "vcn-footer-section" }, _attrs))}><div class="container-fluid vcn-container-footer"><div class="row"><div class="col-md-5"><div class="vcn-footer-brand"><div class="vcn-footer-logo"><img${ssrRenderAttr("src", _imports_0$1)} alt=""></div><p class="vcn-footer-tagline"> Advancing Wellness for Everyday Life <br> Bringing together nature, innovation, and trust to support healthier lifestyles across communities. </p></div><div class="vcn-footer-newsletter"><h3 class="vcn-footer-newsletter-title"> Stay Connected with VCN — Wellness Updates in Your Inbox </h3><p class="vcn-footer-newsletter-subtitle"> Be the first to know about new products, exclusive offers, and health tips. </p><form class="vcn-footer-newsletter-form"><div class="vcn-footer-input-wrapper"><input type="email" class="vcn-footer-newsletter-input" placeholder="Enter your email"${ssrRenderAttr("value", email.value)}${ssrIncludeBooleanAttr(isLoading.value) ? " disabled" : ""} required></div><button type="submit" class="vcn-footer-newsletter-btn">→</button></form><div class="vcn-footer-disclaimer"> The information provided is for general wellness purposes only and is not intended to diagnose, treat, cure, or prevent any disease. Please consult a healthcare professional before use if needed. </div></div></div><div class="col-md-1"></div><div class="col-md-6"><div class="vcn-footer-links-section"><div class="row"><div class="col-lg-4 col-md-6 col-sm-6 mb-4"><h4 class="vcn-footer-column-title">Products</h4><ul class="vcn-footer-links-list"><li><a href="/all-products" class="vcn-footer-link">Shop All</a></li></ul></div><div class="col-lg-4 col-md-6 col-sm-6 mb-4"><h4 class="vcn-footer-column-title">About</h4><ul class="vcn-footer-links-list"><li><a href="/about-us" class="vcn-footer-link">Who We Are</a></li><li><a href="/approach" class="vcn-footer-link">Science</a></li><li><a href="/sustainability" class="vcn-footer-link">Sustainability</a></li><li><a href="/vcn-labs" class="vcn-footer-link">VCNLabs</a></li><li><a href="/blog" class="vcn-footer-link">Blogs</a></li><li><a href="/book-consultancy" class="vcn-footer-link">Book Consultancy</a></li></ul></div><div class="col-lg-4 col-md-6 col-sm-6 mb-4"><h4 class="vcn-footer-column-title">Inquire</h4><ul class="vcn-footer-links-list"><li><a href="/vcn-university" class="vcn-footer-link">Partner</a></li><li><a href="/practitioners" class="vcn-footer-link">Practitioners</a></li></ul></div><div class="col-lg-4 col-md-6 col-sm-6 mb-4"><h4 class="vcn-footer-column-title">Help</h4><ul class="vcn-footer-links-list"><li><a href="javascript:void(0)" class="vcn-footer-link">Help</a></li><li><a href="/contact-us" class="vcn-footer-link">Contact</a></li><li><a href="/login" class="vcn-footer-link">My Account</a></li><li><a href="/entire-world" class="vcn-footer-link">International</a></li></ul></div><div class="col-lg-4 col-md-6 col-sm-6 mb-4"><h4 class="vcn-footer-column-title">Social</h4><ul class="vcn-footer-links-list"><li><a href="https://www.instagram.com/vcnorganic/" target="_blank" class="vcn-footer-link">Instagram</a></li><li><a href="https://www.facebook.com/VCNorganic" target="_blank" class="vcn-footer-link">Facebook</a></li><li><a href="https://in.pinterest.com/vcn_organic/" target="_blank" class="vcn-footer-link">Pinterest</a></li></ul></div><div class="col-lg-4 col-md-6 col-sm-6 mb-4"><h4 class="vcn-footer-column-title">Legal</h4><ul class="vcn-footer-links-list"><li><a href="/terms-conditions" class="vcn-footer-link">Terms + Conditions</a></li><li><a href="/privacy-policy" class="vcn-footer-link">Privacy Policy</a></li><li><a href="/accessibility" class="vcn-footer-link">Accessibility</a></li><li><a href="#" class="vcn-footer-link"> Consent Preferences </a></li><li><a href="/cancellation-and-refund-process" class="vcn-footer-link">Cancellation &amp; Refund Process</a></li><li><a href="/disclaimer" class="vcn-footer-link">Disclaimer</a></li><li><a href="/shipping-policy" class="vcn-footer-link">Shipping Policy</a></li><li><a href="/grievance-redressal" class="vcn-footer-link">Grievance Redressal</a></li></ul></div></div></div></div></div></div>`);
      _push(ssrRenderComponent(ConsentPreferencesModal, {
        ref_key: "consentModal",
        ref: consentModal
      }, null, _parent));
      _push(`</footer>`);
    };
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/TopFooter.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const _imports_0 = publicAssetsURL("/gif/makelifebeter1.gif");
const _sfc_main$2 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: "vcn-awaken-section",
    id: "awakenSection"
  }, _attrs))}><div class="vcn-awaken-gif-container vcn-loaded" id="awakenGif"><img${ssrRenderAttr("src", _imports_0)} alt="Awaken Within" class="vcn-awaken-gif"></div><div class="vcn-awaken-copyright vcn-loaded" id="awakenCopyright">© 2025 VCN</div></section>`);
}
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender]]), { __name: "BottomFooter" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "error",
  __ssrInlineRender: true,
  setup(__props) {
    useHead({
      title: "404 - Are you lost? | VCN",
      meta: [
        { name: "description", content: "The page you're looking for doesn't exist or has been moved. Return to the VCN homepage to continue browsing." }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$3;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "error-page" }, _attrs))} data-v-8419a40a>`);
      ...
      _push(`<main class="error-main" data-v-8419a40a><div class="error-container" data-v-8419a40a><div class="content" data-v-8419a40a><div class="error-number" data-v-8419a40a>404</div><h1 data-v-8419a40a>Page Not Found</h1><p class="sub" data-v-8419a40a> Are you lost? → `);
      ...
      _push(`</p></div><div class="astronaut-container" data-v-8419a40a><img${ssrRenderAttr("src", _imports_0$2)} alt="Error illustration" class="astronaut" loading="lazy" data-v-8419a40a></div></div></main>`);
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-8419a40a"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
export { RegistrationForm as R, _export_sfc as _, __nuxt_component_0$4 as a, useCartStore as b, useAuthCart as c, useToast as d, entry_default as default, __nuxt_component_0$3 as e, useRuntimeConfig as f, useRoute as g, useRouter as h, __nuxt_component_0 as i, __nuxt_component_1 as j, _sfc_main$3 as k, __nuxt_component_3 as l, useHead as u };
